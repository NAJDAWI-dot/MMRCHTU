...
import { ArmedForm, DeskForm, DeskHead, Submit, inputClass, labelClass } from "../DeskKit";
  ...
  return (
    <div className="space-y-8">
      <DeskHead
        icon="book"
        title="Guides"
        lead="The competitor, volunteer, organizer and venue pages. Plain text: “## ” starts a heading, “- ” a list item, and a blank line a new paragraph."
      />
      ...
      <div className="space-y-6">
        {GUIDE_SLUGS.map((slug) => {
          ...
          return (
            <section key={slug} className="day-card p-5 sm:p-6">
              <div className="flex flex-wrap items-baseline justify-between gap-3">
                <h2 className="day-display text-2xl text-day-ink">{fallback.kicker}</h2>
                <Link href={`/day/${slug}`} className="text-sm font-semibold text-day-crimson hover:underline">
